<template>
      ...
      <div class="bg-white p-6 rounded-lg shadow-lg border-amber-500 border">
        <div class="w-full sm:w-[500px] p-4 bg-white sm:p-6 dark:bg-gray-800 mx-auto">
          <div class="flex flex-col items-center pb-3">
            ...
            <h5 class="mb-1 text-xl font-extrabold text-gray-900 dark:text-white">{{card.title}}</h5>
 ...
 <div class="max-w-md mx-auto text-base italic text-gray-600 dark:text-gray-400 leading-relaxed pb-10">
  {{ card.notes }}
</div>
